...
public class FailLeaderTest implements LoggingServer{	
	...
	@Test(timeout = 120000)
	public void failLeaderTest() throws InterruptedException, IOException {
		System.out.println("FailLeaderTest");
		Logger logger = initializeLogging(this.getClass().getSimpleName());
		System.setProperty(LoggingServer.LOGGING_PREFIX, "FailLeaderTest");
